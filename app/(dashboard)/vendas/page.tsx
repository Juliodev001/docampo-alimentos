...
export default async function VendasPage() {
  ...
  const receitaNfe = nfes
    ...
    .reduce((s, n) => s + Number(n.totalValor), 0)
  ...
  return (
    <VendasClient
      nfes={nfes.map((n) => ({
        ...
        numero: n.numero,
        totalValor: Number(n.totalValor),
